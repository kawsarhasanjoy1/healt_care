...
const getMyAppoinment = async (user, filters, options) => {
...
const getAppoinments = async (filters, options) => {
    const { limit, page, skip } = calculatePagination(options);
...
const changeAppointmentStatus = async (appoinmentId, status, user) => {
